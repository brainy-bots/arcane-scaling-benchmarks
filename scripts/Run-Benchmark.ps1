...
.DESCRIPTION
  ...
  - arcane-manager built when -FindArcaneCeiling is used (unless -ArcaneExternalProcesses): arcane/target/release/arcane-manager(.exe).
  - benchmark-cluster built when -FindArcaneCeiling is used (unless -ArcaneExternalProcesses):
